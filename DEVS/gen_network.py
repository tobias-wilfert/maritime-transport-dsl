...
class Network(CoupledDEVS):
	...
	def __init__(self):
		...
		self.Waterway_110_A = self.addSubModel(Waterway("w_c2_LC_A", 5160.0))
		self.Waterway_110_B = self.addSubModel(Waterway("w_c2_LC_B", 5160.0))
		...
		self.Confluence_107 = self.addSubModel(Confluence("c2", 3 + 1, {
			0: 2, int("d1"[-1]): 2, int("d8"[-1]): 0, int("d2"[-1]): 1, int("d7"[-1]): 0, int("d5"[-1]): 1,
			int("d4"[-1]): 1, int("d3"[-1]): 1, int("d6"[-1]): 0, }))
		# Need to do some hacking here
		self.Confluence_80 = self.addSubModel(Confluence("c4", 5 + 1, {
			0: 0, int("d1"[-1]): 4, int("d8"[-1]): 0, int("d2"[-1]): 4, int("d7"[-1]): 0, int("d5"[-1]): 3,
			int("d4"[-1]): 1, int("d3"[-1]): 2, int("d6"[-1]): 0, }))
		self.Confluence_26 = self.addSubModel(CP("CP", 3, {
			0: 2, int("d1"[-1]): 1, int("d8"[-1]): 0, int("d2"[-1]): 1, int("d7"[-1]): 0, int("d5"[-1]): 0,
			int("d4"[-1]): 0, int("d3"[-1]): 0, int("d6"[-1]): 0, }))  # Note: this is a special case
		# Need to do some hacking here
		self.Confluence_45 = self.addSubModel(Confluence("c1", 2 + 1, {
			0: 0, int("d1"[-1]): 1, int("d8"[-1]): 1, int("d2"[-1]): 1, int("d7"[-1]): 1, int("d5"[-1]): 1,
			int("d4"[-1]): 1, int("d3"[-1]): 1, int("d6"[-1]): 1, }))
		# Need to do some hacking here
		self.Confluence_57 = self.addSubModel(Confluence("c5", 3 + 1, {
			0: 2, int("d1"[-1]): 2, int("d8"[-1]): 0, int("d2"[-1]): 1, int("d7"[-1]): 0, int("d5"[-1]): 0,
			int("d4"[-1]): 0, int("d3"[-1]): 0, int("d6"[-1]): 0, }))
		# Need to do some hacking here
		self.Confluence_123 = self.addSubModel(Confluence("c7", 3 + 1, {
			0: 0, int("d1"[-1]): 0, int("d8"[-1]): 0, int("d2"[-1]): 0, int("d7"[-1]): 2, int("d5"[-1]): 0,
			int("d4"[-1]): 0, int("d3"[-1]): 0, int("d6"[-1]): 1, }))
		# Need to do some hacking here
		self.Confluence_53 = self.addSubModel(Confluence("c3", 3 + 1, {
			0: 2, int("d1"[-1]): 1, int("d8"[-1]): 2, int("d2"[-1]): 0, int("d7"[-1]): 2, int("d5"[-1]): 0,
			int("d4"[-1]): 0, int("d3"[-1]): 0, int("d6"[-1]): 2, }))
		# Need to do some hacking here
		self.Confluence_122 = self.addSubModel(Confluence("c6", 3 + 1, {
			0: 2, int("d1"[-1]): 2, int("d8"[-1]): 1, int("d2"[-1]): 2, int("d7"[-1]): 0, int("d5"[-1]): 2,
			int("d4"[-1]): 2, int("d3"[-1]): 2, int("d6"[-1]): 0, }))
