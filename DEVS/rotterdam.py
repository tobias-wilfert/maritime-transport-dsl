...
class Network(CoupledDEVS):
	...
	def __init__(self):
		...
		self.Confluence_45 = self.addSubModel(CP("CP", 3 + 1, {
			0: 1, int("d4"[1:]): 2, int("d3"[1:]): 2, int("d2"[1:]): 2, int("d5"[1:]): 0, int("d7"[1:]): 0,
			int("d1"[1:]): 2, int("d8"[1:]): 0, int("d9"[1:]): 0, int("d6"[1:]): 0,
			int("d10"[1:]): 0, }))  # Note: this is a special case
		# Need to do some hacking here
		self.Confluence_164 = self.addSubModel(Confluence("c1", 5 + 1, {
			0: 3, int("d4"[1:]): 2, int("d3"[1:]): 4, int("d2"[1:]): 1, int("d5"[1:]): 3, int("d7"[1:]): 3,
			int("d1"[1:]): 0, int("d8"[1:]): 3, int("d9"[1:]): 3, int("d6"[1:]): 3, int("d10"[1:]): 3, }))
		# Need to do some hacking here
		self.Confluence_188 = self.addSubModel(Confluence("c2", 4 + 1, {
			0: 2, int("d4"[1:]): 2, int("d3"[1:]): 2, int("d2"[1:]): 2, int("d5"[1:]): 1, int("d7"[1:]): 3,
			int("d1"[1:]): 2, int("d8"[1:]): 3, int("d9"[1:]): 3, int("d6"[1:]): 0, int("d10"[1:]): 3, }))
		# Need to do some hacking here
		self.Confluence_202 = self.addSubModel(Confluence("c3", 5 + 1, {
			0: 4, int("d4"[1:]): 4, int("d3"[1:]): 4, int("d2"[1:]): 4, int("d5"[1:]): 4, int("d7"[1:]): 3,
			int("d1"[1:]): 4, int("d8"[1:]): 2, int("d9"[1:]): 1, int("d6"[1:]): 4, int("d10"[1:]): 0, }))
